...
const hardhat1Brave = "0x70997970c51812dc3a010c7d01b50e0d17dc79c8";
...
async function init() {
    ...
    await xmetric.transfer(hardhat1Brave, ethers.utils.parseEther("50"));

    await xmetric.transfer(hardhat16, ethers.utils.parseEther("116"));
