...
export default function ConnectWalletButton({buttonText, connectWallet, marginAuto}: {buttonText:string, connectWallet?:Dispatch<SetStateAction<boolean>>, marginAuto?: boolean}) {
    return (
        ...
        <button className={`tw-bg-[#21C5F2] tw-px-5 tw-py-3 tw-max-w-xs tw-text-sm tw-rounded-lg tw-text-white tw-mx-auto tw-max-w-[175px] `} onClick={() => {connectWallet && connectWallet(true)}}>
