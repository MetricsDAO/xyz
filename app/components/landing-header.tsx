    ...
    <section className="hero-section">
      ...
      <section className="tw-text-center tw-bg-white lg:tw-bg-transparent">
        <div className="container tw-flex tw-flex-col lg:tw-flex-row tw-gap-20 tw-py-24">
          <div className="feature tw-mx-6 lg:tw-mx-auto" data-aos="fade" data-aos-delay="300" data-aos-duration="2000">
            <div className="feature-icon">
              <img src="img/equal.png" alt="" />
            </div>
            <p>
              We believe that <span className="fw-bold">equal access to on-chain data</span>, regardless of provider, is
              necessary to answer the most pressing questions for decentralized organizations.
            </p>
          </div>
          <div className="feature tw-mx-6 lg:tw-mx-auto" data-aos="fade" data-aos-delay="300" data-aos-duration="2000">
            <div className="feature-icon">
          ...
          <div className="feature tw-mx-6 lg:tw-mx-auto" data-aos="fade" data-aos-delay="300" data-aos-duration="2000">
            ...
            <p>
              We believe that a <span className="fw-bold">new operating system connecting DAOs with analysts</span> will
              fuel the Organized Power Usage needed to drive the next era of Web3 development.
            </p>
          </div>
        </div>
      </section>
