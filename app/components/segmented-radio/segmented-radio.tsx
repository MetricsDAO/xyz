...
export function SegmentedRadio({ isError, value, onChange, options, name }: Props) {
  return (
...
export function ValidatedSegmentedRadio({ onChange, ...props }: Props & { name: string }) {
  ...
  return <SegmentedRadio value={value} onChange={handleChange} isError={Boolean(error)} {...props} />;
}
