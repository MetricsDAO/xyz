...
export default function AlertBanner ({setAlertContainerStatus, transactionStatus}: {setAlertContainerStatus: Dispatch<SetStateAction<boolean>>, transactionStatus: any}) {
    let text: string;
    let element: any;
