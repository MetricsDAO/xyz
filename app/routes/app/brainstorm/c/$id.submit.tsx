        ...
        <div className="flex flex-col-reverse justify-center lg:flex-row  space-y-reverse space-y-8 lg:space-y-0 lg:space-x-16">
          <main className="lg:max-w-xl space-y-7">
            <div>
              ...
              <Text color="dimmed">
                Submit your best question idea. Peers will review and score your question. If you’re a winner, you’ll
                earn tokens and xMETRIC from the challenge reward pool!
              </Text>
            </div>
            <TextInput
            ...
            <Paper p="md" withBorder sx={{ backgroundColor: "#E7F5FF" }} radius="md">
              <Text color="dimmed" className="space-y-6">
                <div className="space-y-3">
                  ...
                  <Text>
                    The original question has many interpretations: SUSHI the token? SUSHI the dex? What is a person?
                    Are we talking Ethereum? What about Polygon?
                  </Text>
                ...
                <div className="space-y-3">
                  ...
                  <Text>
                    What is “active“? What is “use”? These terms can (and will) mean different things to different
                    people. It doesn’t matter what definition you use as long as you communicate your expectations.
                    Alternatively, you can ask for the metric to be defined as part of the question.
                  </Text>
                  <Text weight={500} italic>
                ...
                <div className="space-y-3">
                  ...
                  <Text>
                    We still haven’t fully defined “active”. Specifying time makes the result easier to understand,
