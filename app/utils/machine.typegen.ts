  ...
  export interface Typegen0 {
        '@@xstate/typegen': true;
        internalEvents: {
          "done.invoke.wait-for-preapprove-transaction": { type: "done.invoke.wait-for-preapprove-transaction"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
"done.invoke.wait-for-transaction": { type: "done.invoke.wait-for-transaction"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
"error.platform.wait-for-preapprove-transaction": { type: "error.platform.wait-for-preapprove-transaction"; data: unknown };
...
"waitForTransaction": "SUBMIT_TRANSACTION";
        ...
        matchesStates: "idle" | "transactionPrepared" | "transactionPrepared.preapprove" | "transactionPrepared.preapprove.failure" | "transactionPrepared.preapprove.loading" | "transactionPrepared.preapprove.ready" | "transactionPrepared.preapprove.success" | "transactionPrepared.ready" | "transactionWrite" | "transactionWrite.failure" | "transactionWrite.loading" | "transactionWrite.success" | { "transactionPrepared"?: "preapprove" | "ready" | { "preapprove"?: "failure" | "loading" | "ready" | "success"; };
